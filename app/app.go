...
import (
	...
	eightballmodule "eightball/x/eightball"
	eightballmodulekeeper "eightball/x/eightball/keeper"
	eightballmoduletypes "eightball/x/eightball/types"

	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "eightball/app/params"
	"eightball/docs"
)

const (
	AccountAddressPrefix = "8ball"
	Name                 = "eightball"
)
...
var (
	...
	maccPerms = map[string][]string{
		...
		eightballmoduletypes.ModuleName: {authtypes.Minter, authtypes.Burner},
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, "."+"8ball")
}
