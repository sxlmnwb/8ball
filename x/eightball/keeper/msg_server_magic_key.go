...
func (k msgServer) CreateMagicKey(goCtx context.Context,
	msg *types.MsgCreateMagicKey) (*types.MsgCreateMagicKeyResponse, error) {
	...
	var highCouncilConjurings = types.HighCouncilConjurings{
		MagicKeyId:   id,
		BlockStarted: uint64(ctx.BlockHeight()),
	}

	k.AppendHighCouncilConjurings(
		ctx,
		highCouncilConjurings,
	)

	return &types.MsgCreateMagicKeyResponse{
		Id: id,
	}, nil
}
