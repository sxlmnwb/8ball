...
import (
	...
	base58 "github.com/cosmos/btcutil/base58"
...
func (aa AccAddress) ETHString() string {
	return "0x" + hex.EncodeToString(aa.Bytes())
}

func (aa AccAddress) TRONString() string {
	encoded := base58.CheckEncode(aa.Bytes(), byte(0x41))
	return encoded
}
